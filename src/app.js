...
import { App } from "./js/views/index.view";
...
// import { categoryForm } from "./js/domElements/components/subComponents/formCategories";
// import { noteCard } from "./js/domElements/components/subComponents/noteCard";
...
// ui.printNotes(notes.getNotes(), noteCard, notesContainer);
...
//   // Print the new array
//   ui.printNotes(searchResult, noteCard, notesContainer);
